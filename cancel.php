        ...
        <div id="colorlib-choose">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="choose" style="margin-top: -26px;background: #ffffff !important;">
                            ...
                            <div class="features-services animate-box">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="features animate-box" style="margin-bottom: -33px !important;">
                                           
                                            <div class="desc">
                                                     <h2 style="margin-left: 14px;"></h2>
                                                     <?php 
                           echo '<meta http-equiv="refresh" content="0; url=investment.php" />';exit();
                           ?>
