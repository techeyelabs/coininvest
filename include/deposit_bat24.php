	...
	if($canSave==1) 
	{
		...
		if($amount != '')
		{
			...
			else
			{
				...
				/*echo "".$plan_select_qry['spend_min_amount'];
				echo "<br>".$amount;*/
...
?>
  <div id="contents" style="width:70%;margin-left:25%;"><br/><br/>
	 ...
	 <table width="70%" border="0" cellspacing="0"  cellpadding="0" align="center" >
	      ...
	      <td colspan="2"><h2 style="text-align:center;">Payment Process</h2></td>
              ...
              <tr  >
                <td  style="height:35px;display:none;">Make your deposit with this BTC address  : </td>
                <td  class="orange" style="display:none;"><?=$bitcoin_id; ?></td>
              </tr>
              <tr >
                <td colspan="2" style="text-align:center;">Amount:</td>
              </tr>  
              <tr>
              <td colspan="2" style="text-align:center;">&#x0E3F;<?php echo number_format($amount,8); ?></td>
              </tr>              
              <?php
		  $select=mysql_query("select * from site_statistics where stat_id='14'");
		  $status=$select['status'];
	...
	<tr class="row2">
		...
		?>
          <tr  >
                ...
                <td  colspan="2" align="center"><img style="margin-left:-10px;" src="images/bitcoin.jpeg" /><br />
                 <br></td>
              </tr>
              <tr   >
                <td style="height:35px" colspan="2" align="center">
		...
		?>
          <form method="post" action="https://www.coinpayments.net/index.php" role="form" id="coform"> 
			...
			<input type="hidden" name="item_name" value="<?php echo $_SESSION['planid']; ?>">
			<input type="hidden" name="item_number" value="<?php echo $userid; ?>">			
			
			<input type="hidden" name="on1" value="<?php echo $userid; ?>">
		 ...
		 <input type="hidden" name="want_shipping" value="0">   	
			...
			<input type=hidden name="success_url" value="<?=$yoursite?>/success.php">
           		<input type=hidden name="notify_url" value="<?=$yoursite?>/ipn/bitcoin.php">
                        <input type=hidden name="cancel_url" value="<?=$yoursite?>/failure.php">
			<!-- 	<input type="hidden" name="success_url" value="ipn/bitcoin.php"> -->	
			<!-- <input type="hidden" name="$hmac" value="<?php echo $hmac;?>" > -->
			
			
			
<input type="submit" name="button" style="font-size:14px;background-color:#00bdfa;margin-top:-20px;height:60px;width:130px;" id="button" value="Deposit" class="button" />
<input type="button" name="button" id="button" onclick="window.location='deposit.php'" style="width:130px;margin-top:-20px;font-size:14px;background-color:#00bdfa;height:60px;"  value="Cancel" class="button" />
		</form></td>
