	  ...
	  <nav class="site-navigation text-center " role="navigation">
		<?php if (!isset($_SESSION['userid'])) { ?>
		  <ul class="site-menu-desktop js-clone-nav ml-auto site-nav-wrap-desktop " >
			...
			<li><a href="#press-section" class="nav-link destop">FAQ</a></li>
			<li><a href="#contact-section" class="nav-link destop">Contact</a></li>
		  </ul>
		<?php } else { ?>
		  <?php if ($current_page[2] == 'index.php') { ?>
			<ul class="site-menu-desktop js-clone-nav ml-auto site-nav-wrap-desktop " >
			  <li><a href="../index.php#home-section" class="nav-link destop">Home</a></li>
			  <li><a href="#about-section" class="nav-link destop">About Us</a></li>
			  <li><a href="#investors-section" class="nav-link destop">Investors</a></li>
			  <li><a href="#affiliator-section" class="nav-link destop">Affiliator</a></li>
			  <li><a href="#press-section" class="nav-link destop">FAQ</a></li>
		  ...
		  <?php }else{ ?>
			<ul class="site-menu-desktop js-clone-nav ml-auto site-nav-wrap-desktop " >
			  ...
			  <li><a href="../index.php#press-section" class="nav-link destop">FAQ</a></li>
			  <li><a href="../index.php#contact-section" class="nav-link destop">Contact</a></li>
			</ul>
		  <?php } ?>
		<?php } ?>
	  </nav>
        ...
        <div class="container-fluid jumpingNav" >
            <div class="" style="max-width: 1100px; margin: 0 auto;">
                <div class="row mt-3">
					...
					<nav class="site-navigation text-center " role="navigation">
						<div class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block text-secondary">
							<div class="text-secondary mt-4">
								<a href="../account.php" style="text-align: left; color:#fff" class="nav-link">My account</a>
								<a href="../investment.php" style="text-align: left; color:#fff" class="nav-link">Investment</a>
								<a href="../withdraw.php" style="text-align: left; color:#fff" class="nav-link">Withdraw</a>
								<a href="../investment-history.php" style="text-align: left; color:#fff" class="nav-link">Investment History</a>
								<a href="../earning-history.php" style="text-align: left; color:#fff" class="nav-link">Earning History</a>
								<a href="../my_referral.php" style="text-align: left; color:#fff" class="nav-link">Referal History</a>
								<a href="../withdraw-history.php" style="text-align: left; color:#fff" class="nav-link">Withdraw History</a>
								<a href="../change_password.php" style="text-align: left; color:#fff" class="nav-link">Password Change</a>
								<a href="../logout.php" style="text-align: left; color:#fff" class="nav-link">Logout</a>
							</div>
						</div>
					</nav>
                    </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        ...
        <p>The AtkinSons Bullion Invest Company is an British-owned and operated precious metals wholesaler, retailer and mining company.<br/>
          AtkinSons is the oldest privately run precious metals company in Englind.<br/>
          The AtkinSons is well recognised in England and internationally and the company has a longstanding reputation for selling high quality and trustworthy products.</p>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <ul class="list-unstyled">
              ...
              <li><a href="../index.php#investors-section">Investor</a></li>
              <li><a href="../index.php#affiliator-section">Affiliator</a></li>
              <li><a href="../index.php#press-section">FAQ</a></li>
        ...
        <div class="mb-5">
          ...
          <form action="#" method="post">
            <div class="input-group mb-3">
              <input type="text" class="form-control border-secondary text-black bg-transparent" placeholder="Enter Email" aria-label="Enter Email" aria-describedby="button-addon2">
