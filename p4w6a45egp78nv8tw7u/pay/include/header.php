...
<a href="home.php"><img height="82" width="195" src="../<?php echo $fetch['set_value'];?>" alt="Company Logo"></a>
                    				</div> <!-- logo end -->
<?php
...
?>
      ...
      <a href="home.php" class="dashboard"><img src="assets/icons/small_icons_3/dashboard.png" alt="" /><span class="current">Dashboard</span></a></li>
						...
						<li <?php if($pfile =='create_user.php' || $pfile =='view_users.php' || $pfile =='edit_user.php' || $pfile =='user.php' || $pfile =='export.php' || $pfile =='bulkupload.php' || $pfile =='manual.php') { echo 'class="current"'; } else { echo 'class=""'; } ?>>
