...
<? 
...

	{
		...
		{
			$update=mysql_query("insert into category(cat_name,cat_status) values('$plan_name','$pcdesc')");

			$_SESSION['success_flag']='<font color="#006600">Category Created Successfully</font>';
